...
public class DeviceGroupTest extends JUnitSuite {
  ...
  public void testReplyToRegistrationRequests() {
    ...
    ActorRef<DeviceManagerMessage> groupActor = testKit.spawn(DeviceGroup.behavior("group"));
    ...
    assertEquals(1L, probe.expectMessageClass(TemperatureRecorded.class).requestId);
  }
  ...
  public void testListActiveDevices() {
    ...
    groupActor.tell(new RequestDeviceList(0L, deviceListProbe.getRef()));
  ...
  public void testListActiveDevicesAfterOneShutsDown() {
    ...
    registeredProbe.awaitAssert(() -> {
      groupActor.tell(new RequestDeviceList(1L, deviceListProbe.getRef()));
      ReplyDeviceList r =
